...
import '../../Entities/RestaurantMenuModel.dart';
...
class Globals {
  ...
  Future<void> AppInit() async {
    ...
    final List<MenuItemModel> cafeHotDrinksItems = [
      MenuItemModel(
        id: "85",
        name: "Cappuccino",
    ...
    final List<MenuItemModel> cafeColdDrinksItems = [
      MenuItemModel(
        id: "88",
        name: "Iced Latte",
      ...
      MenuItemModel(
        id: "89",
        name: "Iced Mocha",
        description: "Espresso with chocolate syrup, milk, and ice.",
        price: "1.6 OMR",
        category: "Cold Drinks",
      ),
      MenuItemModel(
    ...
    final List<MenuItemModel> cafeSnacksItems = [
      MenuItemModel(
        id: "91",
        name: "Croissant",
    ...
    final RestaurantsModel cafe42 = RestaurantsModel(
      id: "6",
      name: "42 Cafe",
      address: "Location D",
      email: "42cafe@example.com",
      website: "www.42cafe.om",
      ...
      menusList: [
        RestaurantMenuModel(
          ...
          startDate: DateTime.now().toString(),
          endDate: DateTime.now().add(Duration(days: 365)).toString(),
          menuItems: cafeHotDrinksItems,
        ),
        RestaurantMenuModel(
          id: "2",
          menuName: "Cold Drinks",
          startDate: DateTime.now().toString(),
          endDate: DateTime.now().add(Duration(days: 365)).toString(),
          menuItems: cafeColdDrinksItems,
        ),
        RestaurantMenuModel(
          id: "3",
          menuName: "Snacks",
